...
* Added **Dragonfire**: each trigger spends one of eight fuel cells and produces a flame cone for up to three seconds while LMB remains held. It deals 70 damage per second and up to 210 per cell, the cone can burn several fighters together, and walls stop it at 15 m.

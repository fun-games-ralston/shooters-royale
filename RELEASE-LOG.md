...
* Match Setup now puts Arena and Opponents first, keeps Training Range last, and removes the repeated "Taking in" loadout card. A red, off-by-default **Most Wanted** toggle makes every bot hunt you and ignore each other in Custom Battle only.
